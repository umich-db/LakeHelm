...
def process_general_plans(folder_path, benchmark,schema):
    ...
    tree_roots = {}
    tree_height = {}
    _orig_plans_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'orig_train', 'train', 'data', 'experiment_3', 'unify_plans', 'plans', 'original')
    mapping_tables = extract_all_table_names(_orig_plans_dir)
